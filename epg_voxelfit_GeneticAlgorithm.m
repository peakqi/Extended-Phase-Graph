function epg_voxelfit_GeneticAlgorithm
...
prob.solver='ga';
prob.fitnessfcn=@(x) epg_cpmg_alp_T2_s0_inp(x,fid);
prob.nvars=3;
prob.lb=[50 10 100];
prob.ub=[90 200 8000];
prob.FunctionTolerance=.0000000;

prob.options=gaoptimset('Generations',2000,...
    'Display','iter',...
    'PopInitRange',[50 10 100;...
                    90 100 8000]);
[xx,fval,exitflag,output]=ga(prob);
...
%   text(5,double(fid(1))-100,'recon','Color','blue')
  ...
  %ylim([100,4000])
  title(strcat('GA:T2=',num2str(T2),';S0=',num2str(s0),';\alpha=',num2str(alp),';err=',num2str(fval)))
